...
def main():
    ...
    results_folder = Path("src/stat6207_project/model/results")
    results_folder.mkdir(parents=True, exist_ok=True)

    # Load and split data
    data_path = Path("src/stat6207_project/model/data") / "target_series_new_with_features2.csv"
    ...
    target_books_path = Path("src/stat6207_project/model/data") / "target_books_new.csv"
    ...
    # Load target books
    target_books = pd.read_csv(Path("src/stat6207_project/model/data") / "target_books_new.csv", dtype={"isbn": "string"})
